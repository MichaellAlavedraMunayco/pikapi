...
export const pokemons: Pokemon.Pokemon[] = [
	{
		...
		moves: [
			...
			{ name: 'Power Whip', damage: 90, type: Pokemon.Type.Grass },
		],
		...
		animations: [
			...
			},
			{
				...
				status: Pokemon.Status.Attacking,
			},
			{
	...
	},
	{
		...
		moves: [
			...
			{ name: 'Sludge Bomb', damage: 80, type: Pokemon.Type.Poison },
			{ name: 'Solar Beam', damage: 180, type: Pokemon.Type.Grass },
			{ name: 'Power Whip', damage: 90, type: Pokemon.Type.Grass },
		],
